...
public class ResponsibleDrinkersWebApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ResponsibleDrinkersWebApplication.class);

    public static void main(String[] args) {
        LOGGER.info("*Starting ResponsibleDrinkersWebApplication*");
